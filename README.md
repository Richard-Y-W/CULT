...
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **LIVE**            | Authorized public Bluesky Jetstream shadow collector; 30-emoji Unicode 17.0 registry; one-minute content/language strata; privacy-safe, durable (14-day default retention, survives restarts) post/like/repost/reply/quote cascade linkage with a measured engagement-attribution coverage rate; source lag/health and author concentration. Requires `CULT_DATA_MODE=live-shadow` and PostgreSQL. Live-market is gated off. |
