...
struct Config { double initial_cash{10'000.0}; double fee_rate{.001}; double slippage_rate{.0005}; double annual_borrow_rate{.03}; std::size_t rebalance_every{7}; double maximum_gross_leverage{2.0}; };
struct Result { double total_return{}; double annualized_volatility{}; double sharpe_like{}; double sortino{}; double maximum_drawdown{}; double turnover{}; double gross_exposure{}; double net_exposure{}; double hit_rate{}; std::size_t trade_count{}; double average_holding_period{}; std::vector<double> equity_curve; };
